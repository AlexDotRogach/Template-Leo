(function () {
    const sliderWrap = document.querySelector('.slider__wrapper'),
        sliderElements = document.querySelectorAll('.slider__wrapper .slider__content'),
        butNext = document.querySelector('.slider__next'),
        butBack = document.querySelector('.slider__back'),
        width = window.getComputedStyle(document.querySelector('.footer__slider')).width,
        ...
        let matrix = window.getComputedStyle(sliderWrap).getPropertyValue("transform");
